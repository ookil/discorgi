...
const UPDATE_CHANNEL_MUTATION = gql`
  mutation UpdateChannel($updateChannelData: UpdateChannelInput!) {
    updateChannel(data: $updateChannelData) {
      id
      name
    }
  }
...
const CreateChannelForm = () => {
  ...
  const { openModal, channelId, dispatch } = useContext(ServerContext);
  ...
  return (
    <Modal
      isOpen={openModal === UPDATE_CHANNEL}
      contentLabel='Update Channel'
      style={customStyles}
    >
      <div className='create-channel-content'>
        <div style={{ padding: '20px' }}>
          ...
          <h2 className='modal-title'>Edit Text Channel</h2>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <form id='update-channel' onSubmit={handleSubmit}>
        ...
        <div className='buttons-wrapper'>
          ...
          <button className='button-create-channel' form='update-channel'>
            Update Channel{' '}
          </button>
        </div>
      </div>
