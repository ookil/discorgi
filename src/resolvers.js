...
module.exports = {
  ...
  Subscription: {
    ...
    serverDeleted: {
      subscribe: withFilter(
        (_, __, { pubsub }) => pubsub.asyncIterator(SERVER_DELETED),
        (payload, variables) => {
          return payload.serverDeleted.id === variables.serverId;
        }
      ),
    },
  },
  ...
  Mutation: {
    ...
    updateChannel: (_, { data }, { dataSources }) =>
      dataSources.serverAPI.updateChannel({ data }),
