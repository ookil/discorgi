...
> = S extends true
  ...
  ? 'include' extends U
    ? User  & {
      ...
      ? Array<ServerGetPayload<S['include'][P]>> :
      P extends 'Message'
      ? Array<MessageGetPayload<S['include'][P]>> : never
    }
  : 'select' extends U
...
: 
      ...
      P extends 'adminOfServers'
      ? Array<ServerGetPayload<S['select'][P]>> :
      P extends 'Message'
      ? Array<MessageGetPayload<S['select'][P]>> : never
    }
  : User
...
export type UserCreateInput = {
  ...
  Message?: MessageCreateManyWithoutCreatedByInput
}
...
export type UserUpdateInput = {
  ...
  Message?: MessageUpdateManyWithoutCreatedByInput
}
...
export type MessageCreateInput = {
  ...
  createdBy: UserCreateOneWithoutMessageInput
}
...
export type MessageUpdateInput = {
  ...
  createdBy?: UserUpdateOneRequiredWithoutMessageInput
}
